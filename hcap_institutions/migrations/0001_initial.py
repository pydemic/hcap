        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Required. At most 15 digits.",
                        max_length=15,
                        validators=[django.core.validators.RegexValidator("^[0-9]+$")],
                        verbose_name="CNES registry",
                    ),
                ),
                (
                    "name",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Designates whether the healthcare unit can be used by the system.",
                        verbose_name="active",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        editable=False,
                        help_text="It will be defined according to the state.",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        editable=False,
                        help_text="It will be defined according to the city.",
                        on_delete=django.db.models.deletion.CASCADE,
